...
def dataloader(file1, file2, file3):
    ...
    with codecs.open(file1, 'r', encoding="UTF-8") as f:
        ...
        for line in content:
            ...
            #if len(triple) != 3:
            #    continue
            if triple[0] in entities2id:
                h_ = entities2id[triple[0]]
            if triple[1] in relations2id:    
                r_ = relations2id[triple[1]]
            if triple[2] in entities2id:
...
if __name__ == '__main__':
    ...
    filedir = 'E:/dataset/wikidata5m/'
    file1 = filedir+'wikidata5m_transductive_train.txt' #"WN18\\wordnet-mlj12-train.txt"
    file2 = filedir+'wikidata5m_entity.txt' #"WN18\\entity2id.txt"
    file3 = filedir+'wikidata5m_relation.txt' #"WN18\\relation2id.txt"
    ...
    transE.training_run(out_file_title="wikidata5m_")